...
public class ModelFluidCell implements IModel {
    ...
    public static final ModelFluidCell MODEL = new ModelFluidCell(
            new ResourceLocation("poweradvantage3:items/cell_cover"),
            new ResourceLocation("poweradvantage3:items/cell_empty")
    );

    public static final ModelResourceLocation MODEL_LOCATION = new ModelResourceLocation(new ResourceLocation("poweradvantage3", "fluid_cell"), "default");
    ...
    public static class FluidCellLoader implements ICustomModelLoader {
        ...
        public boolean accepts(ResourceLocation modelLocation) {
            return modelLocation.getResourceDomain().equals("poweradvantage3") && modelLocation.getResourcePath().contains("fluid_cell");
        }
