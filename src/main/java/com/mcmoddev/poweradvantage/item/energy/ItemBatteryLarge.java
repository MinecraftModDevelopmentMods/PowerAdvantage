...
public class ItemBatteryLarge extends Item {
    public ItemBatteryLarge() {
        setUnlocalizedName("poweradvantage.battery_large");
        setRegistryName("battery_large");
    ...
    public static class Energy implements ICapabilitySerializable<NBTTagCompound> {
        ...
        public Energy() {
            this.storage = new EnergyStorage(26000, 1200);
        }
