...
public class ItemBatteryMed extends Item {
    public ItemBatteryMed() {
        setUnlocalizedName("poweradvantage.battery_medium");
        setRegistryName("battery_medium");
    ...
    public static class Energy implements ICapabilitySerializable<NBTTagCompound> {
        ...
        public Energy() {
            this.storage = new EnergyStorage(12000, 700);
        }
