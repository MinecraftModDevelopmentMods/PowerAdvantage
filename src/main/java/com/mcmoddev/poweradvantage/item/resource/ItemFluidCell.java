...
public class ItemFluidCell extends Item {
    ...
    public ItemFluidCell() {
        ...
        setUnlocalizedName("poweradvantage.cell");
        setMaxStackSize(16);
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        return String.format(super.getItemStackDisplayName(stack), fluidStack == null ? I18n.translateToLocal("item.poweradvantage.cell.empty.name") : fluidStack.getLocalizedName());
    }
